...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PRSW\Docker\Generated\Model\SystemInfo::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PRSW\Docker\Generated\Model\SystemInfo::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PRSW\Docker\Generated\Model\SystemInfo();
            ...
            if (\array_key_exists('Plugins', $data)) {
                $object->setPlugins($this->denormalizer->denormalize($data['Plugins'], \PRSW\Docker\Generated\Model\PluginsInfo::class, 'json', $context));
            }
            ...
            if (\array_key_exists('RegistryConfig', $data) && $data['RegistryConfig'] !== null) {
                $object->setRegistryConfig($this->denormalizer->denormalize($data['RegistryConfig'], \PRSW\Docker\Generated\Model\RegistryServiceConfig::class, 'json', $context));
            }
            ...
            if (\array_key_exists('GenericResources', $data)) {
                ...
                foreach ($data['GenericResources'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \PRSW\Docker\Generated\Model\GenericResourcesItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Runtimes', $data)) {
                ...
                foreach ($data['Runtimes'] as $key => $value_4) {
                    $values_4[$key] = $this->denormalizer->denormalize($value_4, \PRSW\Docker\Generated\Model\Runtime::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Swarm', $data)) {
                $object->setSwarm($this->denormalizer->denormalize($data['Swarm'], \PRSW\Docker\Generated\Model\SwarmInfo::class, 'json', $context));
            }
            ...
            if (\array_key_exists('ContainerdCommit', $data)) {
                $object->setContainerdCommit($this->denormalizer->denormalize($data['ContainerdCommit'], \PRSW\Docker\Generated\Model\Commit::class, 'json', $context));
            }
            if (\array_key_exists('RuncCommit', $data)) {
                $object->setRuncCommit($this->denormalizer->denormalize($data['RuncCommit'], \PRSW\Docker\Generated\Model\Commit::class, 'json', $context));
            }
            if (\array_key_exists('InitCommit', $data)) {
                $object->setInitCommit($this->denormalizer->denormalize($data['InitCommit'], \PRSW\Docker\Generated\Model\Commit::class, 'json', $context));
            }
            ...
            if (\array_key_exists('DefaultAddressPools', $data)) {
                ...
                foreach ($data['DefaultAddressPools'] as $value_6) {
                    $values_6[] = $this->denormalizer->denormalize($value_6, \PRSW\Docker\Generated\Model\SystemInfoDefaultAddressPoolsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Containerd', $data) && $data['Containerd'] !== null) {
                $object->setContainerd($this->denormalizer->denormalize($data['Containerd'], \PRSW\Docker\Generated\Model\ContainerdInfo::class, 'json', $context));
            }
        ...
        {
            return [\PRSW\Docker\Generated\Model\SystemInfo::class => false];
        }
    }
} else {
    class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
