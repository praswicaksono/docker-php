...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TaskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PRSW\Docker\Generated\Model\Task::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PRSW\Docker\Generated\Model\Task::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PRSW\Docker\Generated\Model\Task();
            ...
            if (\array_key_exists('Spec', $data)) {
                $object->setSpec($this->denormalizer->denormalize($data['Spec'], \PRSW\Docker\Generated\Model\TaskSpec::class, 'json', $context));
            }
            ...
            if (\array_key_exists('AssignedGenericResources', $data)) {
                ...
                foreach ($data['AssignedGenericResources'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \PRSW\Docker\Generated\Model\GenericResourcesItem::class, 'json', $context);
                }
                $object->setAssignedGenericResources($values_1);
            }
            if (\array_key_exists('Status', $data)) {
                $object->setStatus($this->denormalizer->denormalize($data['Status'], \PRSW\Docker\Generated\Model\TaskStatus::class, 'json', $context));
            }
            if (\array_key_exists('DesiredState', $data)) {
                $object->setDesiredState($data['DesiredState']);
            }
            if (\array_key_exists('JobIteration', $data)) {
                $object->setJobIteration($this->denormalizer->denormalize($data['JobIteration'], \PRSW\Docker\Generated\Model\ObjectVersion::class, 'json', $context));
            }
            return $object;
        }
        ...
        {
            return [\PRSW\Docker\Generated\Model\Task::class => false];
        }
    }
} else {
    class TaskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
