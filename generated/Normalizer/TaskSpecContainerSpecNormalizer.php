...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PRSW\Docker\Generated\Model\TaskSpecContainerSpec::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PRSW\Docker\Generated\Model\TaskSpecContainerSpec::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PRSW\Docker\Generated\Model\TaskSpecContainerSpec();
            ...
            if (\array_key_exists('Privileges', $data)) {
                $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], \PRSW\Docker\Generated\Model\TaskSpecContainerSpecPrivileges::class, 'json', $context));
            }
            ...
            if (\array_key_exists('Mounts', $data)) {
                ...
                foreach ($data['Mounts'] as $value_5) {
                    $values_5[] = $this->denormalizer->denormalize($value_5, \PRSW\Docker\Generated\Model\Mount::class, 'json', $context);
                }
            ...
            if (\array_key_exists('DNSConfig', $data)) {
                $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], \PRSW\Docker\Generated\Model\TaskSpecContainerSpecDNSConfig::class, 'json', $context));
            }
            if (\array_key_exists('Secrets', $data)) {
                $values_7 = [];
                foreach ($data['Secrets'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, \PRSW\Docker\Generated\Model\TaskSpecContainerSpecSecretsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Configs', $data)) {
                ...
                foreach ($data['Configs'] as $value_8) {
                    $values_8[] = $this->denormalizer->denormalize($value_8, \PRSW\Docker\Generated\Model\TaskSpecContainerSpecConfigsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Ulimits', $data)) {
                ...
                foreach ($data['Ulimits'] as $value_12) {
                    $values_12[] = $this->denormalizer->denormalize($value_12, \PRSW\Docker\Generated\Model\TaskSpecContainerSpecUlimitsItem::class, 'json', $context);
                }
        ...
        {
            return [\PRSW\Docker\Generated\Model\TaskSpecContainerSpec::class => false];
        }
    }
} else {
    class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
